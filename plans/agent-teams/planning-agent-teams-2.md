...
- [x] **Build /plan-spec skill**: Implemented (2026-02-12), not yet tested
- [x] **Fix /plan-overview issues**: Applied fixes #1-#5 to SKILL.md (2026-02-12)
- [ ] **Test /plan-spec**: Run `/plan-spec apps/plans/multi-select-email/overview.md` to validate Phase 2
